...
import com.example.kochBuch.UserFxmlLoader;
...
public class CategoryController implements Initializable {
    ...
    @FXML void vegan(MouseEvent event)  throws Exception{
        UserFxmlLoader.loadFXML("/com/example/kochBuch/KategorienView/VeganView.fxml");
    }
    @FXML void fleisch(MouseEvent event)  throws Exception{
        UserFxmlLoader.loadFXML("/com/example/kochBuch/KategorienView/FleischView.fxml");
    }
    @FXML void seafood(MouseEvent event)  throws Exception{
        UserFxmlLoader.loadFXML("/com/example/kochBuch/KategorienView/SeafoodView.fxml");
    }
    @FXML void vorspeise(MouseEvent event)  throws Exception{
        UserFxmlLoader.loadFXML("/com/example/kochBuch/KategorienView/VorspeiseView.fxml");
    }
    @FXML void nachspeise(MouseEvent event)  throws Exception{
        UserFxmlLoader.loadFXML("/com/example/kochBuch/KategorienView/NachspeiseView.fxml");
    }
    @FXML void persisch(MouseEvent event)  throws Exception{
        UserFxmlLoader.loadFXML("/com/example/kochBuch/KategorienView/PersischView.fxml");
    }
